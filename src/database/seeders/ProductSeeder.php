    ...
    public function run()
    {
        DB::table('products')->insert([
            [
                ...
                'image'       => 'images/kiwi.png', // public/storage/images/kiwi.jpg
            ],
            [
                'name'        => 'ストロベリー',
                'price'       => 1200,
                'description' => '大人から子供まで大人気のストロベリー。当店では鮮度抜群の完熟いちごを使用しています。ビタミンCや食物繊維も豊富で腸内環境の改善も期待できます。もぎたてフルーツのスムージーをお召し上がりください！',
